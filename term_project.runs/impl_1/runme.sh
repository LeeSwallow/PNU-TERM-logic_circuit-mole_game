...
HD_PWD='D:/Univ/logic_circuit/term_project/term_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gm.tcl -notrace
