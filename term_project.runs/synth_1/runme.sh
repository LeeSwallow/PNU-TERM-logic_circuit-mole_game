...
HD_PWD='D:/Univ/logic_circuit/term_project/term_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gm.tcl
